...
function RectBoyScene:ctor()
    ...
    local function createRectBoy()
        ...
        local body = cc.PhysicsBody:createBox(spriteBoy:getContentSize(), MATERIAL_DEFAULT)
    ...
    local function onEnter()
        ...
        groundNode:setPhysicsBody(cc.PhysicsBody:createEdgeSegment(cc.p(-1500, 0), cc.p(1500, 0), MATERIAL_DEFAULT))
        ...
        local function update()
            ...
            if #layer:getChildren() < obstacleNum then
                ...
                for i = 0, obstacleNum - #layer:getChildren() do
                    ...
                    node:setPhysicsBody(cc.PhysicsBody:createEdgeSegment(cc.p(-50, 0), cc.p(50, 0), MATERIAL_DEFAULT))
